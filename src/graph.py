class DirectedGraph(object):
    ...
    def push_map(self,location=(0,0,0),plan=[],signals=[]):
        try:
            import pusher
            import json
    ...
    def get_map(self,location,plan,signals):
        ...
        return { "size": [max_rows, max_cols], "map": map_nodes, "location": location, "plan": plan, "signals": signal_map }
